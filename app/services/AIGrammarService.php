...
class AIGrammarService {
    ...
    private function buildPrompt($content, $analyze_grammar, $analyze_vocabulary) {
        $instructions = "Analyze the following text for ";
        
        if ($analyze_grammar && $analyze_vocabulary) {
            $instructions .= "grammar errors and vocabulary improvements.";
        } elseif ($analyze_grammar) {
            $instructions .= "grammar errors only.";
        } else {
            $instructions .= "vocabulary improvements only.";
        }
