...
?>
<link rel="stylesheet" href="../../../public/css/admin/admin_sidebar.css"> 
...
<div class="sidebar">
    ...
    <nav id="sidebar-nav">
        <div class="top-links">
            <a href="admin-dashboard.php"<?php if ($currentPage == 'admin-dashboard.php') echo ' class="active"'; ?>><i class="fas fa-home"></i> Overview</a>
            <a href="manage_users.php"<?php if ($currentPage == 'manage_users.php') echo ' class="active"'; ?>><i class="fas fa-users"></i> Manage Users</a>
