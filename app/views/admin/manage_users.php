...
<body>
  ...
  <script>
    ...
    $scriptName = $_SERVER['SCRIPT_NAME']; // e.g., /app/views/admin/manage_users.php
    $scriptDir = dirname($scriptName); // e.g., /app/views/admin
  ...
  <script src="../../../public/js/admin/manage_users.js"></script>
</body>
</html>
