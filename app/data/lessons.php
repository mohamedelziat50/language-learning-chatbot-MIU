[
    ...
    [
        ...
        "topic_id" => 1,
        "icon" => "fas fa-book",
        "description" => "Learn key words and phrases for Greetings",
        "difficulty" => "beginner",
        "content" => [
    ...
    [
        ...
        "topic_id" => 1,
        "icon" => "fas fa-comment",
        "description" => "Useful expressions and sentences for Greetings",
        "difficulty" => "beginner",
        "content" => [
    ...
    [
        ...
        "description" => "Important grammar rules for Greetings",
        "difficulty" => "beginner",
        "content" => [
    ...
    [
        ...
        "topic_id" => 1,
        "icon" => "fas fa-users",
        "description" => "Real-life dialogue examples for Greetings",
        "difficulty" => "beginner",
        "content" => [
    ...
    [
        ...
        "topic_id" => 2,
        "icon" => "fas fa-book",
        "description" => "Learn key words for Food & Dining",
        "difficulty" => "beginner",
        "content" => [
    ...
    [
        "id" => 6,
        "title" => "Food & Dining - Phrases",
        "type" => "phrases",
        "language_id" => 1,
        "topic_id" => 2,
        "icon" => "fas fa-comment",
        "description" => "Useful expressions for Food & Dining",
        "difficulty" => "beginner",
        "content" => [
    ...
    [
        "id" => 7,
        "title" => "Food & Dining - Grammar",
        "type" => "grammar",
        "language_id" => 1,
        "topic_id" => 2,
        "icon" => "fas fa-language",
        "description" => "Grammar rules for Food & Dining",
        "difficulty" => "beginner",
        "content" => [
    ...
    [
        "id" => 8,
        "title" => "Food & Dining - Conversation",
        "type" => "conversation",
        "language_id" => 1,
        "topic_id" => 2,
        "icon" => "fas fa-users",
        "description" => "Real-life dialogue examples for Food & Dining",
        "difficulty" => "beginner",
        "content" => [
    ...
    [
        "id" => 11,
        "title" => "Basics - Grammar",
        "type" => "grammar",
        "language_id" => 2,
        "topic_id" => 3,
        "icon" => "fas fa-language",
        "description" => "Basic Spanish grammar",
        "difficulty" => "beginner",
        "content" => [
    ...
    [
        "id" => 12,
        "title" => "Basics - Conversation",
        "type" => "conversation",
        "language_id" => 2,
        "topic_id" => 3,
        "icon" => "fas fa-users",
        "description" => "Simple conversation examples",
        "difficulty" => "beginner",
        "content" => [
